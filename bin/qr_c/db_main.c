...
/* return error_collection_cw_t structure */
error_collection_cw_t error_correction_cw(VERSION_QR version,ERROR_CORRECT_LEVEL level){
	error_collection_cw_t error_correction;
	int version_level=0;
	version_level = version | level;
	switch (version_level) {
			case 0x0101: /* LEVEL_L, VERSION_1 */
