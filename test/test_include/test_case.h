...
extern int check_data_error_correction_cw(error_collection_cw_t in1, error_collection_cw_t in2);

/* function QR */
extern character_capacities_t version_qr(VERSION_QR version,ERROR_CORRECT_LEVEL level);
extern error_collection_cw_t error_correction_cw(VERSION_QR version,ERROR_CORRECT_LEVEL level);
