...
export LD_LIBRARY_PATH=~/workspace/QR_CODE/build/jni
...
2. all file *.so save in build/jni/ folder
###############################################################################################
###################################		GUIDE ECLIPSE				 ##########################
###############################################################################################
1. config run application, add vm configure: java -Djava.library.path=build/jni